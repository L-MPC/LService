 ...
 */
#define TOX_MAX_NAME_LENGTH            1024
 ...
 */
#define TOX_MAX_STATUS_MESSAGE_LENGTH  2048
 ...
 */
#define TOX_MAX_FRIEND_REQUEST_LENGTH  2048
 ...
 */
#define TOX_MAX_MESSAGE_LENGTH         2048
...
typedef enum TOX_USER_STATUS {
	...
	/**
	* User is inv. Signals to other clients that this client is like offline
	*/
	//TOX_USER_STATUS_INV,
 ...
 * @param message_id The message ID as returned from tox_friend_send_message corresponding to the message sent.
 */
